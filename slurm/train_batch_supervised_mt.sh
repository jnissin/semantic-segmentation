...
srun python -m src.train --model enet-naive-upsampling --mfolder enet-naive-upsampling-supervised-mt --trainer segmentation --config ./configs/config-segmentation-supervised-mt.json --wdir /scratch/work/jhnissin/semantic-segmentation/