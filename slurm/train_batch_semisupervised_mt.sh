...
srun python -m src.train --model enet-naive-upsampling --mfolder enet-naive-upsampling-semisupervised-mt --trainer semisupervised-segmentation --config ./config/config-segmentation-semisupervised-mt.json