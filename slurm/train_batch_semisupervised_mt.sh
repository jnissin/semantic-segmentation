...
srun python -m src.train --model enet-naive-upsampling --mfolder enet-naive-upsampling-semisupervised-mt --trainer semisupervised-segmentation --config ./configs/config-segmentation-semisupervised-mt.json --wdir /scratch/work/jhnissin/semantic-segmentation/ --maxjobs 4