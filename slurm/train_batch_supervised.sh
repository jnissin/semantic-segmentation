...
srun python -m src.train --model enet-naive-upsampling --mfolder enet-naive-upsampling-supervised-bboxw-gnoise --trainer segmentation --config ./configs/config-segmentation-supervised.json --wdir /scratch/work/jhnissin/semantic-segmentation/ --maxjobs 4