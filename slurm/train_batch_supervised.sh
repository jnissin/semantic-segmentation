...
srun python -m src.train --model enet-naive-upsampling --mfolder enet-naive-upsampling-supervised --trainer segmentation --config ./config/config-segmentation-supervised.json