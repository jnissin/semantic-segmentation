...
srun python -m src.train --model enet-naive-upsampling --mfolder enet-naive-upsampling-supervised --trainer segmentation --config ./configs/config-segmentation-supervised.json --wdir /scratch/work/jhnissin/semantic-segmentation/