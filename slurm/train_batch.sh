...
srun python /scratch/work/jhnissin/semantic-segmentation/src/train_segmentation.py /scratch/work/jhnissin/semantic-segmentation/configs/config-segmentation-triton.json