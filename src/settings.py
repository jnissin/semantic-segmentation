...
TEST_DATA_GENERATOR_WORKERS = 2

DATA_GENERATION_THREADS_PER_PROCESS = 1

VALIDATION_DATA_MAX_QUEUE_SIZE = 10
TRAINING_DATA_MAX_QUEUE_SIZE = 20
TEST_DATA_MAX_QUEUE_SIZE = 10

# nearest, bilinear or cubic
SEGMENTATION_MASK_RESIZE_INTERPOLATION_TYPE = 'nearest'
SEGMENTATION_MASK_TRANSFORM_INTERPOLATION_TYPE = 'nearest'
SEGMENTATION_PHOTO_RESIZE_INTERPOLATION_TYPE = 'bilinear'
SEGMENTATION_PHOTO_TRANSFORM_INTERPOLATION_TYPE = 'bilinear'

CLASSIFICATION_PHOTO_RESIZE_INTERPOLATION_TYPE = 'bilinear'
CLASSIFICATION_PHOTO_TRANSFORM_INTERPOLATION_TYPE = 'bilinear'

QUEUE_SIZE_REPORT_INTERVAL = None

USE_XLA = False
USE_MULTIPROCESSING = True
COPY_DATASET_TO_TMP = False
...
OVERRIDE_TEST_STEPS_PER_EPOCH = None
